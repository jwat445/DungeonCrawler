...
HXLINE(  56)		 ::flixel::_hx_system::debug::watch::WatchEntryData _g = this->data;
...
HXLINE( 111)		 ::flixel::_hx_system::debug::watch::WatchEntryData _g = this->data;
...
HXLINE( 111)				return ::Reflect_obj::getProperty(object,field);
            			}
            			break;
            			case (int)1: {
...
HXLINE( 111)				return value;
            			...
            			break;
            			case (int)2: {
HXLINE( 115)				::String expression = _g->_hx_getString(0);
...
HXLINE( 136)		 ::flixel::_hx_system::debug::watch::WatchEntryData _g = this->data;
