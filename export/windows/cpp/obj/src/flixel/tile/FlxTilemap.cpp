...
void FlxTilemap_obj::updateMap(){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_356_updateMap)
...
HXLINE( 996)							 ::openfl::_legacy::geom::Point _hx_tmp6 = this->_flashPoint;
HXDLIN( 996)							_hx_tmp6->x = (_hx_tmp6->x + this->_tileWidth);
            						}
HXLINE( 997)						columnIndex = (columnIndex + (int)1);
            					}
            				}
HXLINE(1000)				if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1001)					 ::openfl::_legacy::geom::Point _hx_tmp7 = this->_flashPoint;
HXDLIN(1001)					_hx_tmp7->y = (_hx_tmp7->y + this->_tileHeight);
            				}
