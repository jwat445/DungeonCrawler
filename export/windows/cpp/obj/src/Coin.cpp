...
HX_DEFINE_STACK_FRAME(_hx_pos_09010fb71e803ec8_14_new,"Coin","new",0x704aaf23,"Coin.new","Coin.hx",14,0x01a6c5ad)
HX_LOCAL_STACK_FRAME(_hx_pos_09010fb71e803ec8_20_kill,"Coin","kill",0xcf15eb7b,"Coin.kill","Coin.hx",20,0x01a6c5ad)
HX_LOCAL_STACK_FRAME(_hx_pos_09010fb71e803ec8_27_finishKill,"Coin","finishKill",0x3e72412e,"Coin.finishKill","Coin.hx",27,0x01a6c5ad)

void Coin_obj::__construct(hx::Null< Float >  __o_X,hx::Null< Float >  __o_Y){
Float X = __o_X.Default(0);
Float Y = __o_Y.Default(0);
            	HX_STACKFRAME(&_hx_pos_09010fb71e803ec8_14_new)
HXLINE(  15)		super::__construct(X,Y,null());
HXLINE(  16)		this->loadGraphic(HX_("assets/images/coin.png",f7,e9,c5,54),false,(int)16,(int)16,null(),null());
            	}
...
void Coin_obj::kill(){
            	HX_STACKFRAME(&_hx_pos_09010fb71e803ec8_20_kill)
HXLINE(  21)		this->set_alive(false);
HXLINE(  22)		::flixel::tweens::FlxTween_obj::tween(hx::ObjectPtr<OBJ_>(this), ::Dynamic(hx::Anon_obj::Create(2)
...
void Coin_obj::finishKill( ::flixel::tweens::FlxTween _){
            	HX_STACKFRAME(&_hx_pos_09010fb71e803ec8_27_finishKill)
HXDLIN(  27)		this->set_exists(false);
            	}
...
hx::ObjectPtr< Coin_obj > Coin_obj::__alloc(hx::Ctx *_hx_ctx,hx::Null< Float >  __o_X,hx::Null< Float >  __o_Y) {
