...
@:keep @:bind #if display private #end class __ASSET__assets_data_room000_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_room001_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_room002_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_room003_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_room004_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_room005_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_room006_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_tiles_oep extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_music_menu_wav extends flash.media.Sound { }
...
@:keep @:bind #if display private #end class __ASSET__assets_sounds_step_1_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_step_2_wav extends flash.media.Sound { }
